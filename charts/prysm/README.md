...
| image.repository | string | `"gcr.io/prysmaticlabs/prysm/beacon-chain"` | Prysm container image repository Multi-Arch (arm64/amd64) image repository: gcr.io/prylabs-dev/prysm/beacon-chain Official image |
| image.tag | string | `"latest"` | Prysm container image tag |
